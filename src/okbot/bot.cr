...
# To get a up to date list of all supported coins you need to grab them from https://www.cryptonator.com/api/currencies . Somehow I'm failing to GET this endpoint (it's not supported officialy anymore)
